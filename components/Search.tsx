...
const Search = () => {
  ...
  return (
    <div className=" absolute top-[92%] text-[#7A7A7A]">
      <div className="flex justify-center">
        <div className="bg-white w-full rounded-3xl py-[22px]  border border-secondary px-[45px] shadow-xl flex items-end justify-between gap-3">
